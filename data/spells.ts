...
export const SPELLS_CATALOG: SpellDefinition[] = [
  {
    ...
    save: { stat: 'dex', onSuccess: 'half' },
    shortDescription: '1d6 acid, DEX save, dual-target 5ft',
    requiresConcentration: false,
    tags: ['conjuration', 'damage', 'acid']
  },
  {
    id: 'chill-touch',
    name: 'Chill Touch',
    ...
    attackRoll: true,
    shortDescription: '1d8 necrotic, no healing, undead disadv',
    requiresConcentration: false,
    tags: ['necromancy', 'damage', 'necrotic']
  },
  {
    id: 'dancing-lights',
    name: 'Dancing Lights',
    ...
    shortDescription: '4 lights, bonus action move',
    tags: ['evocation']
  },
  {
    id: 'druidcraft',
    ...
    classes: ['druid'],
    requiresConcentration: false,
    shortDescription: 'Minor nature effects',
    tags: ['transmutation']
  },
  {
    id: 'eldritch-blast',
    ...
    shortDescription: '1d10 force per beam, scales 5/11/17',
    classes: ['warlock'],
  ...
  },
  {
    ...
    attackRoll: true,
    shortDescription: '1d10 fire, ignites flammable',
    requiresConcentration: false,
  ...
  },
  {
    ...
    shortDescription: 'd4 to one ability check',
  ...
  },
  {
    ...
    requiresConcentration: false,
    shortDescription: '20ft bright light for 1 hour',
    tags: ['evocation']
  },
  {
    id: 'mage-hand',
    ...
    requiresConcentration: false,
    shortDescription: 'Spectral hand, 30ft range',
    tags: ['conjuration']
  },
  {
    id: 'mending',
    ...
    classes: ['cleric', 'druid', 'bard', 'sorcerer', 'wizard'],
    requiresConcentration: false,
    shortDescription: 'Repair 1ft break or tear',
    tags: ['transmutation']
  },
  {
    id: 'message',
    ...
    classes: ['bard', 'sorcerer', 'wizard'],
    requiresConcentration: false,
    shortDescription: 'Whisper message to target',
    tags: ['transmutation']
  },
  {
    id: 'minor-illusion',
  ...
  },
  {
    ...
    save: { stat: 'con', onSuccess: 'half' },
    shortDescription: '1d12 poison, CON save',
    requiresConcentration: false,
    tags: ['conjuration', 'damage', 'poison']
  },
  {
    id: 'prestidigitation',
    ...
    components: { verbal: true, somatic: true },
    duration: '1 hour',
    description: 'This spell is a minor magical trick that novice spellcasters use for practice. You create one of the following magical effects within \'range\':  - You create an instantaneous, harmless sensory effect, such as a shower of sparks, a puff of wind, faint musical notes, or an odd odor.  - You instantaneously light or snuff out a candle, a torch, or a small campfire.  - You instantaneously clean or soil an object no larger than 1 cubic foot.  - You chill, warm, or flavor up to 1 cubic foot of nonliving material for 1 hour.  - You make a color, a small mark, or a symbol appear on an object or a surface for 1 hour.  - You create a nonmagical trinket or an illusory image that can fit in your hand and that lasts until the end of your next turn.  If you cast this spell multiple times, you can have ...',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: false,
    shortDescription: 'Minor magical tricks',
    tags: ['transmutation']
  },
  {
    id: 'produce-flame',
    ...
    attackRoll: true,
    shortDescription: '1d8 fire, light source',
    requiresConcentration: false,
    aoe: { shape: 'sphere', size: 10 },
    tags: ['conjuration', 'damage', 'fire']
  },
  {
    id: 'ray-of-frost',
    name: 'Ray of Frost',
    ...
    attackRoll: true,
    shortDescription: '1d8 cold, -10ft speed',
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'cold']
  },
  {
    id: 'resistance',
    name: 'Resistance',
    ...
    shortDescription: 'd4 to one saving throw',
    classes: ['cleric', 'druid'],
    requiresConcentration: true,
    tags: ['abjuration']
  },
  {
    ...
    shortDescription: '1d8 radiant, ignores cover',
    classes: ['cleric'],
    damage: { dice: '1d8', type: 'radiant' },
    save: { stat: 'dex', onSuccess: 'half' },
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'radiant']
  },
  {
    id: 'shillelagh',
    name: 'Shillelagh',
    ...
    classes: ['druid'],
    requiresConcentration: false,
    shortDescription: 'Weapon becomes spellcasting mod, d8, magical',
    tags: ['transmutation']
  },
  {
    id: 'shocking-grasp',
    ...
    attackRoll: true,
    shortDescription: '1d8 lightning, no reactions, adv vs metal',
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'lightning']
  },
  {
    id: 'spare-the-dying',
    ...
    classes: ['cleric'],
    requiresConcentration: false,
    shortDescription: 'Stabilize 0 HP creature',
    tags: ['necromancy']
  },
  {
    id: 'thaumaturgy',
    ...
    classes: ['cleric'],
    requiresConcentration: false,
    shortDescription: 'Minor thaumaturgic effects',
    tags: ['transmutation']
  },
  {
    id: 'true-strike',
    ...
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
    shortDescription: 'Advantage on next attack',
    tags: ['divination']
  },
  {
    id: 'vicious-mockery',
    ...
    save: { stat: 'wis', onSuccess: 'half' },
    shortDescription: '1d4 psychic, disadv on next attack',
    requiresConcentration: false,
  ...
  },
  {
    ...
    shortDescription: 'WIS save, charmed (beasts only)',
    condition: { type: 'charmed', saveTo: 'wis', onFailedSave: 'none' },
  ...
  },
  {
    ...
    shortDescription: 'CHA save, -1d4 on attacks/saves',
    condition: { type: 'bane', saveTo: 'cha', onFailedSave: 'none' },
  ...
  },
  {
    ...
    shortDescription: '+1d4 on attacks/saves for 3 allies',
  ...
  },
  {
    ...
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 2, bonusDice: '1d6' }, { atSlotLevel: 3, bonusDice: '2d6' }, { atSlotLevel: 4, bonusDice: '3d6' }, { atSlotLevel: 5, bonusDice: '4d6' }, { atSlotLevel: 6, bonusDice: '5d6' }, { atSlotLevel: 7, bonusDice: '6d6' }, { atSlotLevel: 8, bonusDice: '7d6' }, { atSlotLevel: 9, bonusDice: '8d6' }],
    requiresConcentration: false,
  ...
  },
  {
    ...
    shortDescription: 'WIS save, charmed condition',
    save: { stat: 'wis', onSuccess: 'none' },
    condition: { type: 'charmed', saveTo: 'wis', onFailedSave: 'none' },
  ...
  },
  {
    ...
    shortDescription: '6d10 HP pool, blinds creatures',
    condition: { type: 'blinded', saveTo: null, onFailedSave: 'none', duration: 1 },
    hpPoolDice: '6d10',
    hpPoolCondition: 'blinded',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: false,
    aoe: { shape: 'cone', size: 15 },
    tags: ['illusion']
  },
  {
    ...
    components: { verbal: true, somatic: false },
    duration: '1 round',
    description: 'You speak a one-word command to a creature you can see within range. The target must succeed on a wisdom saving throw or follow the command on its next turn. The spell has no effect if the target is undead, if it doesn\'t understand your language, or if your command is directly harmful to it. Some typical commands and their effects follow. You might issue a command other than one described here. If you do so, the DM determines how the target behaves. If the target can\'t follow your command, the spell ends  **Approach.** The target moves toward you by the shortest and most direct route, ending its turn if it moves within 5 feet of you. **Drop** The target drops whatever it is holding and then ends its turn. **Flee.** The target spends its turn moving away from you by the fastest available...',
    shortDescription: 'WIS save, obey command',
    save: { stat: 'wis', onSuccess: 'none' },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A pinch of soot and salt.' },
    duration: '1 hour',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A drop of water if creating water, or a few grains of sand if destroying it.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    classes: ['cleric', 'druid', 'ranger', 'bard', 'paladin'],
    healing: '1d8+yourspellcastingabilitymodifier',
    scaling: [{ atSlotLevel: 2, bonusDice: '1d8' }, { atSlotLevel: 3, bonusDice: '2d8' }, { atSlotLevel: 4, bonusDice: '3d8' }, { atSlotLevel: 5, bonusDice: '4d8' }, { atSlotLevel: 6, bonusDice: '5d8' }, { atSlotLevel: 7, bonusDice: '6d8' }, { atSlotLevel: 8, bonusDice: '7d8' }, { atSlotLevel: 9, bonusDice: '8d8' }],
    requiresConcentration: false,
    tags: ['evocation']
  },
  {
  ...
  },
  {
    ...
    classes: ['cleric', 'druid', 'ranger', 'bard', 'sorcerer', 'wizard', 'paladin'],
    requiresConcentration: true,
    ritual: true,
    tags: ['divination']
  },
  ...
  },
  {
    ...
    shortDescription: 'STR save, restrained',
    save: { stat: 'str', onSuccess: 'none' },
    condition: { type: 'restrained', saveTo: 'str', onFailedSave: 'none' },
    classes: ['druid'],
    requiresConcentration: true,
    tags: ['conjuration']
  },
  ...
  },
  {
    ...
    shortDescription: 'DEX save, advantage on attacks, no invisible',
    save: { stat: 'dex', onSuccess: 'none' },
    classes: ['cleric', 'druid', 'bard', 'warlock'],
    requiresConcentration: true,
    tags: ['evocation']
  },
  {
    ...
    duration: '1 hour',
    description: 'Bolstering yourself with a necromantic facsimile of life, you gain 1d4 + 4 temporary hit points for the duration. When you cast this spell using a spell slot of 2nd level or higher, you gain 5 additional temporary hit points for each slot level above 1st.',
    shortDescription: '1d4+4 temp HP, +5 per slot',
    healing: '1d4+4',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: false,
    tags: ['necromancy']
  },
  {
    ...
    range: '60 feet',
    components: { verbal: true, somatic: false, material: 'A small feather or a piece of down.' },
    duration: '1 minute',
  ...
  },
  {
    ...
    shortDescription: '4d6 radiant, grants advantage on next attack',
    classes: ['cleric'],
  ...
  },
  {
    ...
    scaling: [{ atSlotLevel: 2, bonusDice: '1d4' }, { atSlotLevel: 3, bonusDice: '2d4' }, { atSlotLevel: 4, bonusDice: '3d4' }, { atSlotLevel: 5, bonusDice: '4d4' }, { atSlotLevel: 6, bonusDice: '5d4' }, { atSlotLevel: 7, bonusDice: '6d4' }, { atSlotLevel: 8, bonusDice: '7d4' }, { atSlotLevel: 9, bonusDice: '8d4' }],
    requiresConcentration: false,
    tags: ['evocation']
  },
  {
    ...
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 2, bonusDice: '1d10' }, { atSlotLevel: 3, bonusDice: '2d10' }, { atSlotLevel: 4, bonusDice: '3d10' }, { atSlotLevel: 5, bonusDice: '4d10' }, { atSlotLevel: 6, bonusDice: '5d10' }, { atSlotLevel: 7, bonusDice: '6d10' }, { atSlotLevel: 8, bonusDice: '7d10' }, { atSlotLevel: 9, bonusDice: '8d10' }],
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'fire']
  },
  {
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'Tiny tarts and a feather that is waved in the air.' },
    duration: 'Up to 1 minute',
    ...
    shortDescription: 'WIS save, prone+incapacitated',
    save: { stat: 'wis', onSuccess: 'none' },
    condition: { type: 'incapacitated', saveTo: 'wis', onFailedSave: 'none' },
  ...
  },
  {
    ...
    requiresConcentration: true,
    durationScaling: [{ atSlotLevel: 3, value: 480 }, { atSlotLevel: 5, value: 1440 }],
    tags: ['divination']
  },
  {
    id: 'identify',
    ...
    castingTime: 'minute',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A pearl worth at least 100gp and an owl feather.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Touch',
    components: { verbal: false, somatic: true, material: 'A lead-based ink worth at least 10gp, which this spell consumes.' },
    duration: '10 days',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: 'Instantaneous',
    description: 'Make a melee spell attack against a creature you can reach. On a hit, the target takes 3d10 necrotic damage. When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d10 for each slot level above 1st.',
    classes: ['cleric'],
  ...
  },
  {
    ...
    duration: '1 hour',
    description: 'You touch a creature. The target\'s speed increases by 10 feet until the spell ends. When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each spell slot above 1st.',
    classes: ['druid', 'ranger', 'bard', 'wizard'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  {
    ...
    shortDescription: 'AC = 13 + DEX for 8 hours',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
    ...
    shortDescription: '3 darts auto-hit, 1d4+1 force each',
    autoHit: true,
    dartCount: 3,
    classes: ['sorcerer', 'wizard'],
  ...
  },
  {
    ...
    classes: ['cleric', 'warlock', 'wizard', 'paladin'],
    requiresConcentration: true,
    tags: ['abjuration']
  },
  {
  ...
  },
  {
    ...
    shortDescription: '+5 AC reaction, immune to magic missile',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
    ...
    castingTime: 'bonus',
    range: '60 feet',
    components: { verbal: true, somatic: true, material: 'A small parchment with a bit of holy text written on it.' },
    duration: 'Up to 10 minutes',
    description: 'A shimmering field appears and surrounds a creature of your choice within range, granting it a +2 bonus to AC for the duration.',
    shortDescription: '+2 AC for 10 minutes',
    classes: ['cleric', 'paladin'],
    requiresConcentration: true,
    tags: ['abjuration']
  },
  {
    ...
    duration: 'Up to 10 minutes',
    description: 'You create the image of an object, a creature, or some other visible phenomenon that is no larger than a 15-foot cube. The image appears at a spot within range and lasts for the duration. The image is purely visual; it isn\'t accompanied by sound, smell, or other sensory effects. You can use your action to cause the image to move to any spot within range. As the image changes location, you can alter its appearance so that its movements appear natural for the image. For example, if you create an image of a creature and move it, you can alter the image so that it appears to be walking. Physical interaction with the image reveals it to be an illusion, because things can pass through it. A creature that uses its action to examine the image can determine that it is an illusion with a successf...',
    classes: ['bard', 'sorcerer', 'wizard'],
    requiresConcentration: true,
    tags: ['illusion']
  },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '90 feet',
    components: { verbal: true, somatic: true, material: 'Powdered rhubarb leaf and an adder\'s stomach.' },
    duration: 'Instantaneous',
    ...
    attackRoll: true,
    scaling: [{ atSlotLevel: 3, bonusDice: '1d4' }, { atSlotLevel: 4, bonusDice: '2d4' }, { atSlotLevel: 5, bonusDice: '3d4' }, { atSlotLevel: 6, bonusDice: '4d4' }, { atSlotLevel: 7, bonusDice: '5d4' }, { atSlotLevel: 8, bonusDice: '6d4' }, { atSlotLevel: 9, bonusDice: '7d4' }],
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'acid']
  },
  {
    id: 'aid',
    name: 'Aid',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Gold dust worth at least 25gp, which the spell consumes.' },
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'Specially marked sticks, bones, or similar tokens worth at least 25gp.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    shortDescription: 'CON save, blinded or deafened',
    save: { stat: 'con', onSuccess: 'none' },
    condition: { type: 'blinded', saveTo: 'con', onFailedSave: 'none' },
  ...
  },
  {
    ...
    shortDescription: 'CHA save, suppress charm/frightened',
    save: { stat: 'cha', onSuccess: 'none' },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Either a pinch of dried carrot or an agate.' },
    duration: '8 hours',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A copper coin.' },
    duration: 'Up to 1 minute',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: 'Instantaneous',
    description: 'You summon a spirit that assumes the form of an unusually intelligent, strong, and loyal steed, creating a long-lasting bond with it. Appearing in an unoccupied space within range, the steed takes on a form that you choose, such as a warhorse, a pony, a camel, an elk, or a mastiff. (Your DM might allow other animals to be summoned as steeds.) The steed has the statistics of the chosen form, though it is a celestial, fey, or fiend (your choice) instead of its normal type. Additionally, if your steed has an Intelligence of 5 or less, its Intelligence becomes 6, and it gains the ability to understand one language of your choice that you speak. Your steed serves you as a mount, both in combat and out, and you have an instinctive bond with it that allows you to fight as a seamless unit. Whil...',
    classes: ['paladin'],
    requiresConcentration: false,
    tags: ['conjuration']
  },
  ...
  },
  {
    ...
    castingTime: 'bonus',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'Leaf of sumac.' },
    duration: 'Up to 10 minutes',
    ...
    shortDescription: '3d6 fire melee, +1d6 per 2 slots above 2nd',
    classes: ['druid'],
    damage: { dice: '3d6', type: 'fire' },
    attackRoll: true,
    scaling: [{ atSlotLevel: 4, bonusDice: '1d6' }, { atSlotLevel: 6, bonusDice: '2d6' }, { atSlotLevel: 8, bonusDice: '3d6' }],
    requiresConcentration: true,
    aoe: { shape: 'sphere', size: 10 },
    tags: ['evocation', 'damage', 'fire']
  },
  {
    ...
    duration: 'Up to 1 minute',
    description: 'A 5-foot-diameter sphere of fire appears in an unoccupied space of your choice within range and lasts for the duration. Any creature that ends its turn within 5 feet of the sphere must make a dexterity saving throw. The creature takes 2d6 fire damage on a failed save, or half as much damage on a successful one. As a bonus action, you can move the sphere up to 30 feet. If you ram the sphere into a creature, that creature must make the saving throw against the sphere\'s damage, and the sphere stops moving this turn. When you move the sphere, you can direct it over barriers up to 5 feet tall and jump it across pits up to 10 feet wide. The sphere ignites flammable objects not being worn or carried, and it sheds bright light in a 20-foot radius and dim light for an additional 20 feet. When yo...',
    classes: ['cleric', 'druid', 'wizard'],
    damage: { dice: '2d6', type: 'fire' },
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 3, bonusDice: '1d6' }, { atSlotLevel: 4, bonusDice: '2d6' }, { atSlotLevel: 5, bonusDice: '3d6' }, { atSlotLevel: 6, bonusDice: '4d6' }, { atSlotLevel: 7, bonusDice: '5d6' }, { atSlotLevel: 8, bonusDice: '6d6' }, { atSlotLevel: 9, bonusDice: '7d6' }],
    requiresConcentration: true,
    tags: ['conjuration', 'damage', 'fire']
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A pinch of salt and one copper piece placed on each of the corpse\'s eyes, which must remain there for the duration.' },
    duration: '10 days',
  ...
  },
  {
    ...
    shortDescription: 'STR save, push 15ft, difficult terrain',
    save: { stat: 'str', onSuccess: 'none' },
    classes: ['cleric', 'druid', 'sorcerer', 'wizard'],
    requiresConcentration: true,
    aoe: { shape: 'line', size: 60 },
    tags: ['evocation']
  },
  {
    id: 'heat-metal',
  ...
  },
  {
    ...
    shortDescription: 'WIS save, paralyzed',
    save: { stat: 'wis', onSuccess: 'none' },
    condition: { type: 'paralyzed', saveTo: 'wis', onFailedSave: 'none' },
    classes: ['cleric', 'druid', 'bard', 'sorcerer', 'warlock', 'wizard', 'paladin'],
    requiresConcentration: true,
    tags: ['enchantment']
  },
  {
    ...
    duration: 'Up to 1 hour',
    description: 'A creature you touch becomes invisible until the spell ends. Anything the target is wearing or carrying is invisible as long as it is on the target\'s person. The spell ends for a target that attacks or casts a spell. When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.',
    shortDescription: 'Invisible until attack or cast',
    condition: { type: 'invisible', saveTo: null, onFailedSave: 'none' },
  ...
  },
  {
    ...
    duration: 'Up to 10 minutes',
    description: 'One creature or object of your choice that you can see within range rises vertically, up to 20 feet, and remains suspended there for the duration. The spell can levitate a target that weighs up to 500 pounds. An unwilling creature that succeeds on a constitution saving throw is unaffected. The target can move only by pushing or pulling against a fixed object or surface within reach (such as a wall or a ceiling), which allows it to move as if it were climbing. You can change the target\'s altitude by up to 20 feet in either direction on your turn. If you are the target, you can move up or down as part of your move. Otherwise, you can use your action to move the target, which must remain within the spell\'s range. When the spell ends, the target floats gently to the ground if it is still al...',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: true,
    tags: ['transmutation']
  },
  ...
  },
  {
    ...
    classes: ['cleric', 'druid', 'ranger', 'bard', 'wizard', 'paladin'],
    requiresConcentration: true,
    tags: ['divination']
  },
  {
  ...
  },
  {
    ...
    classes: ['druid', 'sorcerer', 'warlock', 'wizard', 'paladin'],
    requiresConcentration: false,
    tags: ['conjuration']
  },
  {
    ...
    save: { stat: 'con', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 3, bonusDice: '1d10' }, { atSlotLevel: 4, bonusDice: '2d10' }, { atSlotLevel: 5, bonusDice: '3d10' }, { atSlotLevel: 6, bonusDice: '4d10' }, { atSlotLevel: 7, bonusDice: '5d10' }, { atSlotLevel: 8, bonusDice: '6d10' }, { atSlotLevel: 9, bonusDice: '7d10' }],
    requiresConcentration: true,
    tags: ['evocation', 'damage', 'radiant']
  },
  {
  ...
  },
  {
    ...
    classes: ['cleric'],
    healing: '2d8+yourspellcastingabilitymodifier',
    scaling: [{ atSlotLevel: 3, bonusDice: '1d8' }, { atSlotLevel: 4, bonusDice: '2d8' }, { atSlotLevel: 5, bonusDice: '3d8' }, { atSlotLevel: 6, bonusDice: '4d8' }, { atSlotLevel: 7, bonusDice: '5d8' }, { atSlotLevel: 8, bonusDice: '6d8' }, { atSlotLevel: 9, bonusDice: '7d8' }],
    requiresConcentration: false,
    tags: ['evocation']
  },
  {
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A dash of talc and a small amount of silver powder.' },
    duration: '1 hour',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '60 feet',
    components: { verbal: true, somatic: true, material: 'A burst of mica.' },
    duration: 'Instantaneous',
    ...
    shortDescription: '3d8 thunder, CON save for half',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '150 feet',
    components: { verbal: true, somatic: true, material: 'Seven sharp spines or seven twigs cut peak.' },
    duration: 'Up to 10 minutes',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '1 minute',
    description: 'You create a floating, spectral weapon within range that lasts for the duration or until you cast this spell again. When you cast the spell, you can make a melee spell attack against a creature within 5 feet of the weapon. On a hit, the target takes force damage equal to 1d8 + your spellcasting ability modifier. As a bonus action on your turn, you can move the weapon up to 20 feet and repeat the attack against a creature within 5 feet of it. The weapon can take whatever form you choose. Clerics of deities who are associated with a particular weapon (as St. Cuthbert is known for his mace and Thor for his hammer) make this spell\'s effect resemble that weapon. When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for every two slot levels above the...',
    shortDescription: '1d8+mod force melee, +1d8 per 2 slots above 2nd',
    classes: ['cleric'],
    damage: { dice: '1d8', type: 'force' },
    attackRoll: true,
    scaling: [{ atSlotLevel: 3, bonusDice: '1d8' }, { atSlotLevel: 5, bonusDice: '2d8' }, { atSlotLevel: 7, bonusDice: '3d8' }, { atSlotLevel: 9, bonusDice: '4d8' }],
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'force']
  },
  {
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A pair of platinum rings worth at least 50gp each, which you and the target must wear for the duration.' },
    duration: '1 hour',
  ...
  },
  {
    ...
    shortDescription: 'DEX save, restrained+difficult terrain',
    save: { stat: 'dex', onSuccess: 'none' },
    condition: { type: 'restrained', saveTo: 'dex', onFailedSave: 'none' },
    classes: ['druid', 'sorcerer', 'wizard'],
    requiresConcentration: true,
    tags: ['conjuration']
  },
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '1 minute',
    description: 'Roll a d20 at the end of each of your turns for the duration of the spell. On a roll of 11 or higher, you vanish from your current plane of existence and appear in the Ethereal Plane (the spell fails and the casting is wasted if you were already on that plane). At the start of your next turn, and when the spell ends if you are on the Ethereal Plane, you return to an unoccupied space of your choice that you can see within 10 feet of the space you vanished from. If no unoccupied space is available within that range, you appear in the nearest unoccupied space (chosen at random if more than one space is equally near). You can dismiss this spell as an action. While on the Ethereal Plane, you can see and hear the plane you originated from, which is cast in shades of gray, and you can\'t see an...',
    classes: ['cleric', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  {
    ...
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 4, bonusDice: '1d10' }, { atSlotLevel: 5, bonusDice: '2d10' }, { atSlotLevel: 6, bonusDice: '3d10' }, { atSlotLevel: 7, bonusDice: '4d10' }, { atSlotLevel: 8, bonusDice: '5d10' }, { atSlotLevel: 9, bonusDice: '6d10' }],
    requiresConcentration: true,
    tags: ['conjuration', 'damage', 'lightning']
  },
  {
    id: 'clairvoyance',
    name: 'Clairvoyance',
    ...
    castingTime: '10 minutes',
    range: '1 mile',
    components: { verbal: true, somatic: true, material: 'A focus worth at least 100gp, either a jeweled horn for hearing or a glass eye for seeing.' },
    duration: 'Up to 10 minutes',
  ...
  },
  {
    ...
    shortDescription: 'Summon beasts CR 1/4 or lower',
    classes: ['druid', 'ranger'],
    requiresConcentration: true,
    tags: ['conjuration']
  },
  {
    ...
    shortDescription: 'Reaction, ability check vs spell level',
  ...
  },
  {
    ...
    shortDescription: 'Ability check vs spell level',
    classes: ['cleric', 'druid', 'bard', 'sorcerer', 'warlock', 'wizard', 'paladin'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
    ...
    shortDescription: 'WIS save, frightened, forced Dash',
    save: { stat: 'wis', onSuccess: 'none' },
    condition: { type: 'frightened', saveTo: 'wis', onFailedSave: 'none' },
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
  ...
  },
  {
    ...
    shortDescription: '8d6 fire, 20ft sphere, DEX save',
    aoe: { shape: 'sphere', size: 20 },
    classes: ['sorcerer', 'wizard'],
    damage: { dice: '8d6', type: 'fire' },
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 4, bonusDice: '1d6' }, { atSlotLevel: 5, bonusDice: '2d6' }, { atSlotLevel: 6, bonusDice: '3d6' }, { atSlotLevel: 7, bonusDice: '4d6' }, { atSlotLevel: 8, bonusDice: '5d6' }, { atSlotLevel: 9, bonusDice: '6d6' }],
    requiresConcentration: false,
    tags: ['evocation', 'damage', 'fire']
  },
  {
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A bit of gauze and a wisp of smoke.' },
    duration: 'Up to 1 hour',
  ...
  },
  {
    ...
    shortDescription: 'Double speed, +2 AC, extra action',
    classes: ['druid', 'sorcerer', 'wizard', 'paladin'],
    requiresConcentration: true,
    tags: ['transmutation']
  },
  {
    ...
    shortDescription: 'WIS save, charmed+incapacitated',
    save: { stat: 'wis', onSuccess: 'none' },
    condition: { type: 'incapacitated', saveTo: 'wis', onFailedSave: 'none' },
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
  ...
  },
  {
    ...
    shortDescription: '8d6 lightning, 100ft line, DEX save',
    aoe: { shape: 'line', size: 100 },
    classes: ['druid', 'sorcerer', 'wizard'],
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true, material: 'A bit of fleece.' },
    duration: 'Up to 10 minutes',
    description: 'You create the image of an object, a creature, or some other visible phenomenon that is no larger than a 20-foot cube. The image appears at a spot that you can see within range and lasts for the duration. It seems completely real, including sounds, smells, and temperature appropriate to the thing depicted. You can\'t create sufficient heat or cold to cause damage, a sound loud enough to deal thunder damage or deafen a creature, or a smell that might sicken a creature (like a troglodyte\'s stench). As long as you are within range of the illusion, you can use your action to cause the image to move to any other spot within range. As the image changes location, you can alter its appearance so that its movements appear natural for the image. For example, if you create an image of a creature an...',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
    tags: ['illusion']
  },
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '8 hours',
    description: 'You step into a stone object or surface large enough to fully contain your body, melding yourself and all the equipment you carry with the stone for the duration. Using your movement, you step into the stone at a point you can touch. Nothing of your presence remains visible or otherwise detectable by nonmagical senses. While merged with the stone, you can\'t see what occurs outside it, and any Wisdom (Perception) checks you make to hear sounds outside it are made with disadvantage. You remain aware of the passage of time and can cast spells on yourself while merged in the stone. You can use your movement to leave the stone where you entered it, which ends the spell. You otherwise can\'t move. Minor physical damage to the stone doesn\'t harm you, but its partial destruction or a change in i...',
    classes: ['cleric', 'druid'],
    requiresConcentration: false,
    ritual: true,
    tags: ['transmutation']
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A pinch of diamond dust worth 25 gp sprinkled over the target, which the spell consumes.' },
    duration: '8 hours',
    ...
    classes: ['cleric', 'ranger', 'bard', 'wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
  ...
  },
  {
    ...
    classes: ['cleric', 'druid', 'ranger', 'bard', 'warlock', 'paladin'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  {
    ...
    classes: ['cleric', 'druid', 'ranger', 'sorcerer', 'wizard', 'paladin'],
    requiresConcentration: true,
    tags: ['abjuration']
  },
  {
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Diamonds worth 300gp, which the spell consumes.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '10 minutes',
    description: 'You imbue plants within 30 feet of you with limited sentience and animation, giving them the ability to communicate with you and follow your simple commands. You can question plants about events in the spell\'s area within the past day, gaining information about creatures that have passed, weather, and other circumstances. You can also turn difficult terrain caused by plant growth (such as thickets and undergrowth) into ordinary terrain that lasts for the duration. Or you can turn ordinary terrain where plants are present into difficult terrain that lasts for the duration, causing vines and branches to hinder pursuers, for example. Plants might be able to perform other tasks on your behalf, at the DM\'s discretion. The spell doesn\'t enable plants to uproot themselves and move about, but t...',
    classes: ['druid', 'ranger', 'bard'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A small crystal bead.' },
    duration: '8 hours',
    description: 'A 10-foot-radius immobile dome of force springs into existence around and above you and remains stationary for the duration. The spell ends if you leave its area. Nine creatures of Medium size or smaller can fit inside the dome with you. The spell fails if its area includes a larger creature or more than nine creatures. Creatures and objects within the dome when you cast this spell can move through it freely. All other creatures and objects are barred from passing through it. Spells and other magical effects can\'t extend through the dome or be cast through it. The atmosphere inside the space is comfortable and dry, regardless of the weather outside. Until the spell ends, you can command the interior to become dimly lit or dark. The dome is opaque from the outside, of any color you choos...',
    classes: ['bard', 'wizard'],
    requiresConcentration: false,
    ritual: true,
    aoe: { shape: 'sphere', size: 10 },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A short piece of reed or straw.' },
    duration: '24 hours',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '90 feet',
    components: { verbal: true, somatic: true, material: 'A piece of tentacle from a giant octopus or a giant squid' },
    duration: 'Up to 1 minute',
  ...
  },
  {
    ...
    save: { stat: 'con', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 5, bonusDice: '1d8' }, { atSlotLevel: 6, bonusDice: '2d8' }, { atSlotLevel: 7, bonusDice: '3d8' }, { atSlotLevel: 8, bonusDice: '4d8' }, { atSlotLevel: 9, bonusDice: '5d8' }],
    requiresConcentration: false,
    tags: ['necromancy', 'damage', 'necrotic']
  },
  {
  ...
  },
  {
    ...
    shortDescription: '500ft teleport, no line of sight needed',
    classes: ['cleric', 'bard', 'sorcerer', 'warlock', 'wizard', 'paladin'],
    requiresConcentration: false,
    tags: ['conjuration']
  },
  {
    ...
    castingTime: 'action',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'Incense and a sacrificial offering appropriate to your religion, together worth at least 25gp, which the spell consumes.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A tiny silver whistle, a piece of bone, and a thread' },
    duration: '8 hours',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A little phosphorus or a firefly.' },
    duration: '10 minutes',
  ...
  },
  {
    ...
    shortDescription: 'Invisible, can attack and cast',
    classes: ['druid', 'bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
    tags: ['illusion']
  },
  ...
  },
  {
    ...
    shortDescription: '2d8 bludg + 4d6 cold, DEX save',
    secondaryDamage: [{ dice: '4d6', type: 'cold' }],
    classes: ['cleric', 'druid', 'sorcerer', 'wizard', 'paladin'],
    damage: { dice: '2d8', type: 'bludgeoning' },
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 5, bonusDice: '1d8' }, { atSlotLevel: 6, bonusDice: '2d8' }, { atSlotLevel: 7, bonusDice: '3d8' }, { atSlotLevel: 8, bonusDice: '4d8' }, { atSlotLevel: 9, bonusDice: '5d8' }],
    requiresConcentration: false,
    aoe: { shape: 'cylinder', size: 20 },
    tags: ['evocation', 'damage', 'bludgeoning']
  },
  {
    id: 'locate-creature',
  ...
  },
  {
    ...
    castingTime: '10 minutes',
    range: '120 feet',
    components: { verbal: true, somatic: true, material: 'A thin sheet of lead, a piece of opaque glass, a wad of cotton or cloth, and powdered chrysolite.' },
    duration: '24 hours',
    description: 'You make an area within range magically secure. The area is a cube that can be as small as 5 feet to as large as 100 feet on each side. The spell lasts for the duration or until you use an action to dismiss it. When you cast the spell, you decide what sort of security the spell provides, choosing any or all of the following properties:  - Sound can\'t pass through the barrier at the edge of the warded area.  - The barrier of the warded area appears dark and foggy, preventing vision (including darkvision) through it.  - Sensors created by divination spells can\'t appear inside the protected area or pass through the barrier at its perimeter.  - Creatures in the area can\'t be targeted by divination spells.  - Nothing can teleport into or out of the warded area.  - Planar travel is blocked wi...',
    classes: ['wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A hemispherical piece of clear crystal and a matching hemispherical piece of gum arabic.' },
    duration: 'Up to 1 minute',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Soft clay, to be crudely worked into the desired shape for the stone object.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    shortDescription: '4d8 force (Clenched Fist), concentration',
    classes: ['wizard'],
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'An agate worth at least 1,000 gp, which the spell consumes.' },
    duration: 'Instantaneous',
    description: 'After spending the casting time tracing magical pathways within a precious gemstone, you touch a Huge or smaller beast or plant. The target must have either no Intelligence score or an Intelligence of 3 or less. The target gains an Intelligence of 10. The target also gains the ability to speak one language you know. If the target is a plant, it gains the ability to move its limbs, roots, vines, creepers, and so forth, and it gains senses similar to a human\'s. Your DM chooses statistics appropriate for the awakened plant, such as the statistics for the awakened shrub or the awakened tree. The awakened beast or plant is charmed by you for 30 days or until you or your companions do anything harmful to it. When the charmed condition ends, the awakened creature chooses whether to remain frie...',
    classes: ['druid', 'bard'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: 'Up to 1 minute',
    description: 'You attempt to beguile a humanoid that you can see within range. It must succeed on a wisdom saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are fighting it, it has advantage on the saving throw. While the target is charmed, you have a telepathic link with it as long as the two of you are on the same plane of existence. You can use this telepathic link to issue commands to the creature while you are conscious (no action required), which it does its best to obey. You can specify a simple and general course of action, such as "Attack that creature," "Run over there," or "Fetch that object." If the creature completes the order and doesn\'t receive further direction from you, it defends and preserves itself to the best of its ability. You can ...',
    classes: ['cleric', 'bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
    tags: ['enchantment']
  },
  {
    ...
    castingTime: 'minute',
    range: 'Special',
    components: { verbal: true, somatic: true, material: 'A handful of sand, a dab of ink, and a writing quill plucked from a sleeping bird.' },
    duration: '8 hours',
    description: 'This spell shapes a creature\'s dreams. Choose a creature known to you as the target of this spell. The target must be on the same plane of existence as you. Creatures that don\'t sleep, such as elves, can\'t be contacted by this spell. You, or a willing creature you touch, enters a trance state, acting as a messenger. While in the trance, the messenger is aware of his or her surroundings, but can\'t take actions or move. If the target is asleep, the messenger appears in the target\'s dreams and can converse with the target as long as it remains asleep, through the duration of the spell. The messenger can also shape the environment of the dream, creating landscapes, objects, and other images. The messenger can emerge from the trance at any time, ending the effect of the spell early. The targ...',
    classes: ['druid', 'bard', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['illusion']
  },
  {
    ...
    shortDescription: '4d6 fire + 4d6 radiant',
    secondaryDamage: [{ dice: '4d6', type: 'radiant' }],
    classes: ['cleric', 'warlock', 'paladin'],
    damage: { dice: '4d6', type: 'fire' },
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 6, bonusDice: '1d6' }, { atSlotLevel: 7, bonusDice: '2d6' }, { atSlotLevel: 8, bonusDice: '3d6' }, { atSlotLevel: 9, bonusDice: '4d6' }],
    requiresConcentration: false,
    aoe: { shape: 'cylinder', size: 10 },
    tags: ['evocation', 'damage', 'fire']
  },
  {
    id: 'geas',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Diamond dust worth at least 100gp, which the spell consumes.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '90 feet',
    components: { verbal: true, somatic: true, material: 'A small piece of iron.' },
    duration: 'Up to 1 minute',
  ...
  },
  {
    ...
    save: { stat: 'con', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 6, bonusDice: '1d10' }, { atSlotLevel: 7, bonusDice: '2d10' }, { atSlotLevel: 8, bonusDice: '3d10' }, { atSlotLevel: 9, bonusDice: '4d10' }],
    requiresConcentration: true,
    tags: ['conjuration', 'damage', 'piercing']
  },
  {
    id: 'legend-lore',
    name: 'Legend Lore',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: 'Up to 1 minute',
    description: 'You attempt to reshape another creature\'s memories. One creature that you can see must make a wisdom saving throw. If you are fighting the creature, it has advantage on the saving throw. On a failed save, the target becomes charmed by you for the duration. The charmed target is incapacitated and unaware of its surroundings, though it can still hear you. If it takes any damage or is targeted by another spell, this spell ends, and none of the target\'s memories are modified. While this charm lasts, you can affect the target\'s memory of an event that it experienced within the last 24 hours and that lasted no more than 10 minutes. You can permanently eliminate all memory of the event, allow the target to recall the event with perfect clarity and exacting detail, change its memory of the deta...',
    classes: ['cleric', 'bard', 'wizard'],
    requiresConcentration: true,
    tags: ['enchantment']
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A pinch of sesame seeds.' },
    duration: '1 hour',
  ...
  },
  {
    ...
    classes: ['cleric', 'druid', 'bard', 'wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
  ...
  },
  {
    ...
    castingTime: '1 hour',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Rare oils and unguents worth at least 1,000 gp, which the spell consumes.' },
    duration: 'Instantaneous',
    description: 'You touch a dead humanoid or a piece of a dead humanoid. Provided that the creature has been dead no longer than 10 days, the spell forms a new adult body for it and then calls the soul to enter that body. If the target\'s soul isn\'t free or willing to do so, the spell fails. The magic fashions a new body for the creature to inhabit, which likely causes the creature\'s race to change. The DM rolls a d 100 and consults the following table to determine what form the creature takes when restored to life, or the DM chooses a form. **01-04** Dragonborn **05-13** Dwarf, hill **14-21** Dwarf, mountain **22-25** Elf, dark **26-34** Elf, high **35-42** Elf, wood **43-46** Gnome, forest **47-52** Gnome, rock **53-56** Half-elf **57-60** Half-orc **61-68** Halfling, lightfoot **69-76** Halfling, sto...',
    classes: ['druid'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '8 hours',
    description: 'This spell allows you to change the appearance of any number of creatures that you can see within range. You give each target you choose a new, illusory appearance. An unwilling target can make a charisma saving throw, and if it succeeds, it is unaffected by this spell. The spell disguises physical appearance as well as clothing, armor, weapons, and equipment. You can make each creature seem 1 foot shorter or taller and appear thin, fat, or in between. You can\'t change a target\'s body type, so you must choose a form that has the same basic arrangement of limbs. Otherwise, the extent of the illusion is up to you. The spell lasts for the duration, unless you use your action to dismiss it sooner. The changes wrought by this spell fail to hold up to physical inspection. For example, if you ...',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['illusion']
  },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'Pieces of eggshell from two different kinds of creatures' },
    duration: '1 hour',
  ...
  },
  {
    ...
    aoe: { shape: 'wall', size: 100 },
    classes: ['cleric'],
    damage: { dice: '6d10', type: 'slashing' },
    save: { stat: 'dex', onSuccess: 'half' },
    requiresConcentration: true,
    tags: ['evocation', 'damage', 'slashing']
  },
  {
    id: 'chain-lightning',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '150 feet',
    components: { verbal: true, somatic: true, material: 'The powder of a crushed black pearl worth at least 500 gp.' },
    duration: 'Instantaneous',
    ...
    save: { stat: 'con', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 7, bonusDice: '2d6' }, { atSlotLevel: 8, bonusDice: '4d6' }, { atSlotLevel: 9, bonusDice: '6d6' }],
    requiresConcentration: false,
    aoe: { shape: 'sphere', size: 60 },
    tags: ['necromancy', 'damage', 'necrotic']
  },
  {
    id: 'conjure-fey',
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: '10 feet',
    components: { verbal: true, somatic: true, material: 'One clay pot filled with grave dirt, one clay pot filled with brackish water, and one 150 gp black onyx stone for each corpse.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    shortDescription: '10d6+40 force, 0 on save',
    classes: ['sorcerer', 'wizard'],
    damage: { dice: '10d6+40', type: 'force' },
    save: { stat: 'dex', onSuccess: 'none' },
    scaling: [{ atSlotLevel: 7, bonusDice: '3d6' }, { atSlotLevel: 8, bonusDice: '6d6' }, { atSlotLevel: 9, bonusDice: '9d6' }],
    requiresConcentration: false,
    tags: ['transmutation', 'damage', 'force']
  },
  {
    id: 'eyebite',
    name: 'Eyebite',
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A set of divinatory tools-such as bones, ivory sticks, cards, teeth, or carved runes-worth 100gp and an object from the location you wish to find.' },
  ...
  },
  {
    ...
    castingTime: '10 minutes',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Burning incense, a small measure of brimstone and oil, a knotted string, a small amount of umber hulk blood, and a small silver rod worth at least 10 gp.' },
    duration: '24 hours',
  ...
  },
  {
    ...
    castingTime: '10 minutes',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A gem-encrusted bowl worth at least 1,000gp, which the spell consumes.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A gem, crystal, reliquary, or some other ornamental container worth at least 500 gp.' },
    duration: 'Until dispelled',
    description: 'Your body falls into a catatonic state as your soul leaves it and enters the container you used for the spell\'s material component. While your soul inhabits the container, you are aware of your surroundings as if you were in the container\'s space. You can\'t move or use reactions. The only action you can take is to project your soul up to 100 feet out of the container, either returning to your living body (and ending the spell) or attempting to possess a humanoids body. You can attempt to possess any humanoid within 100 feet of you that you can see (creatures warded by a protection from evil and good or magic circle spell can\'t be possessed). The target must make a charisma saving throw. On a failure, your soul moves into the target\'s body, and the target\'s soul becomes trapped in the co...',
    classes: ['wizard'],
    requiresConcentration: false,
    tags: ['necromancy']
  },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '120 feet',
    components: { verbal: true, somatic: true, material: 'An iron blade and a small bag containing a mixture of soils-clay, loam, and sand.' },
    duration: 'Up to 2 hours',
    description: 'Choose an area of terrain no larger than 40 feet on a side within range. You can reshape dirt, sand, or clay in the area in any manner you choose for the duration. You can raise or lower the area\'s elevation, create or fill in a trench, erect or flatten a wall, or form a pillar. The extent of any such changes can\'t exceed half the area\'s largest dimension. So, if you affect a 40-foot square, you can create a pillar up to 20 feet high, raise or lower the square\'s elevation by up to 20 feet, dig a trench up to 20 feet deep, and so on. It takes 10 minutes for these changes to complete. At the end of every 10 minutes you spend concentrating on the spell, you can choose a new area of terrain to affect. Because the terrain\'s transformation occurs slowly, creatures in the area can\'t usually be...',
    classes: ['druid', 'sorcerer', 'wizard'],
    requiresConcentration: true,
    tags: ['transmutation']
  },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'An ointment for the eyes that costs 25gp; is made from mushroom powder, saffron, and fat; and is consumed by the spell.' },
    duration: '1 hour',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '120 feet',
    components: { verbal: true, somatic: true, material: 'A small piece of quartz.' },
    duration: 'Up to 10 minutes',
    description: 'You create a wall of ice on a solid surface within range. You can form it into a hemispherical dome or a sphere with a radius of up to 10 feet, or you can shape a flat surface made up of ten 10-foot-square panels. Each panel must be contiguous with another panel. In any form, the wall is 1 foot thick and lasts for the duration. If the wall cuts through a creature\'s space when it appears, the creature within its area is pushed to one side of the wall and must make a dexterity saving throw. On a failed save, the creature takes 10d6 cold damage, or half as much damage on a successful save. The wall is an object that can be damaged and thus breached. It has AC 12 and 30 hit points per 10-foot section, and it is vulnerable to fire damage. Reducing a 10-foot section of wall to 0 hit points de...',
    classes: ['wizard'],
    requiresConcentration: true,
    aoe: { shape: 'wall', size: 60 },
    tags: ['evocation']
  },
  {
    ...
    castingTime: 'action',
    range: '120 feet',
    components: { verbal: true, somatic: true, material: 'A handful of thorns.' },
    duration: 'Up to 10 minutes',
    description: 'You create a wall of tough, pliable, tangled brush bristling with needle-sharp thorns. The wall appears within range on a solid surface and lasts for the duration. You choose to make the wall up to 60 feet long, 10 feet high, and 5 feet thick or a circle that has a 20-foot diameter and is up to 20 feet high and 5 feet thick. The wall blocks line of sight. When the wall appears, each creature within its area must make a dexterity saving throw. On a failed save, a creature takes 7d8 piercing damage, or half as much damage on a successful save. A creature can move through the wall, albeit slowly and painfully. For every 1 foot a creature moves through the wall, it must spend 4 feet of movement. Furthermore, the first time a creature enters the wall on a turn or ends its turn there, the cre...',
    classes: ['druid'],
    damage: { dice: '8d8', type: 'slashing' },
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 7, bonusDice: '1d8' }, { atSlotLevel: 8, bonusDice: '2d8' }, { atSlotLevel: 9, bonusDice: '3d8' }],
    requiresConcentration: true,
    aoe: { shape: 'wall', size: 60 },
    tags: ['conjuration', 'damage', 'slashing']
  },
  {
    id: 'wind-walk',
    name: 'Wind Walk',
    ...
    castingTime: 'minute',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'Fire and holy water.' },
    duration: '8 hours',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '60 feet',
    components: { verbal: true, somatic: true, material: 'A miniature platinum sword with a grip and pommel of copper and zinc, worth 250 gp.' },
    duration: 'Up to 1 minute',
    ...
    shortDescription: '3d10 force melee sword, concentration',
    classes: ['bard', 'wizard'],
  ...
  },
  {
    ...
    save: { stat: 'dex', onSuccess: 'half' },
    scaling: [{ atSlotLevel: 8, bonusDice: '1d6' }, { atSlotLevel: 9, bonusDice: '2d6' }],
    requiresConcentration: true,
    aoe: { shape: 'sphere', size: 20 },
    tags: ['evocation', 'damage', 'fire']
  },
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '8 hours',
    description: 'You step into the border regions of the Ethereal Plane, in the area where it overlaps with your current plane. You remain in the Border Ethereal for the duration or until you use your action to dismiss the spell. During this time, you can move in any direction. If you move up or down, every foot of movement costs an extra foot. You can see and hear the plane you originated from, but everything there looks gray, and you can\'t see anything more than 60 feet away. While on the Ethereal Plane, you can only affect and be affected by other creatures on that plane. Creatures that aren\'t on the Ethereal Plane can\'t perceive you and can\'t interact with you, unless a special ability or magic has given them the ability to do so. You ignore all objects and effects that aren\'t on the Ethereal Plane,...',
    classes: ['cleric', 'bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  {
    ...
    shortDescription: '7d8+30 necrotic, zombie on kill',
    classes: ['sorcerer', 'warlock', 'wizard'],
  ...
  },
  {
    ...
    duration: '1 hour',
    description: 'An immobile, invisible, cube-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose. A prison in the shape of a cage can be up to 20 feet on a side and is made from 1/2-inch diameter bars spaced 1/2 inch apart. A prison in the shape of a box can be up to 10 feet on a side, creating a solid barrier that prevents any matter from passing through it and blocking any spells cast into or out from the area. When you cast the spell, any creature that is completely inside the cage\'s area is trapped. Creatures only partially within the area, or those too large to fit inside the area, are pushed away from the center of the area until they are completely outside the area. A creature inside the cag...',
    classes: ['bard', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['evocation']
  },
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: 'Instantaneous',
    description: 'Eight multicolored rays of light flash from your hand. Each ray is a different color and has a different power and purpose. Each creature in a 60-foot cone must make a dexterity saving throw. For each target, roll a d8 to determine which color ray affects it. **1. Red.** The target takes 10d6 fire damage on a failed save, or half as much damage on a successful one. **2. Orange.** The target takes 10d6 acid damage on a failed save, or half as much damage on a successful one. **3. Yellow.** The target takes 10d6 lightning damage on a failed save, or half as much damage on a successful one. **4. Green.** The target takes 10d6 poison damage on a failed save, or half as much damage on a successful one. **5. Blue.** The target takes 10d6 cold damage on a failed save, or half as much damage on...',
    classes: ['sorcerer', 'wizard'],
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '500 miles',
    components: { verbal: true, somatic: true, material: 'A small replica of you made from materials worth at least 5 gp.' },
    duration: 'Up to 24 hours',
    description: 'You create an illusory copy of yourself that lasts for the duration. The copy can appear at any location within range that you have seen before, regardless of intervening obstacles. The illusion looks and sounds like you but is intangible. If the illusion takes any damage, it disappears, and the spell ends. You can use your action to move this illusion up to twice your speed, and make it gesture, speak, and behave in whatever way you choose. It mimics your mannerisms perfectly. You can see through its eyes and hear through its ears as if you were in its space. On your turn as a bonus action, you can switch from using its senses to using your own, or back again. While you are using its senses, you are blinded and deafened in regard to your own surroundings. Physical interaction with the ...',
    classes: ['bard', 'wizard'],
    requiresConcentration: true,
    tags: ['illusion']
  },
  {
    ...
    castingTime: 'minute',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A prayer wheel and holy water.' },
    duration: '1 hour',
  ...
  },
  {
    ...
    castingTime: '1 hour',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A diamond worth at least 1,000gp, which the spell consumes.' },
    duration: 'Instantaneous',
    description: 'You touch a dead creature that has been dead for no more than a century, that didn\'t die of old age, and that isn\'t undead. If its soul is free and willing, the target returns to life with all its hit points. This spell neutralizes any poisons and cures normal diseases afflicting the creature when it died. It doesn\'t, however, remove magical diseases, curses, and the like; if such effects aren\'t removed prior to casting the spell, they afflict the target on its return to life. This spell closes all mortal wounds and restores any missing body parts. Coming back from the dead is an ordeal. The target takes a -4 penalty to all attack rolls, saving throws, and ability checks. Every time the target finishes a long rest, the penalty is reduced by 1 until it disappears. Casting this spell to r...',
    classes: ['cleric', 'bard'],
    requiresConcentration: false,
    tags: ['necromancy']
  },
  {
    ...
    castingTime: 'action',
    range: '100 feet',
    components: { verbal: true, somatic: true, material: 'A lodestone and iron filings.' },
    duration: 'Up to 1 minute',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A powder composed of diamond, emerald, ruby, and sapphire dust worth at least 5,000 gp, which the spell consumes.' },
    duration: 'Until dispelled',
  ...
  },
  {
    ...
    castingTime: '1 hour',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Snow or ice in quantities sufficient to made a life-size copy of the duplicated creature; some hair, fingernail clippings, or other piece of that creature\'s body placed inside the snow or ice; and powdered ruby worth 1,500 gp, sprinkled over the duplicate and consumed by the spell.' },
    duration: 'Until dispelled',
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'Mercury, phosphorus, and powdered diamond and opal with a total value of at least 1,000 gp, which the spell consumes.' },
    duration: 'Until dispelled or triggered',
    description: 'When you cast this spell, you inscribe a harmful glyph either on a surface (such as a section of floor, a wall, or a table) or within an object that can be closed to conceal the glyph (such as a book, a scroll, or a treasure chest). If you choose a surface, the glyph can cover an area of the surface no larger than 10 feet in diameter. If you choose an object, that object must remain in its place; if the object is moved more than 10 feet from where you cast this spell, the glyph is broken, and the spell ends without being triggered. The glyph is nearly invisible, requiring an Intelligence (Investigation) check against your spell save DC to find it. You decide what triggers the glyph when you cast the spell. For glyphs inscribed on a surface, the most typical triggers include touching or ...',
    classes: ['cleric', 'bard', 'wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  {
    ...
    components: { verbal: true, somatic: false },
    duration: 'Instantaneous',
    description: 'This spell instantly transports you and up to eight willing creatures of your choice that you can see within range, or a single object that you can see within range, to a destination you select. If you target an object, it must be able to fit entirely inside a 10-foot cube, and it can\'t be held or carried by an unwilling creature. The destination you choose must be known to you, and it must be on the same plane of existence as you. Your familiarity with the destination determines whether you arrive there successfully. The DM rolls d100 and consults the table. **Familiarity.** "Permanent circle" means a permanent teleportation circle whose sigil sequence you know. "Associated object" means that you possess an object taken from the desired destination within the last six months, such as a...',
    classes: ['bard', 'sorcerer', 'wizard'],
    requiresConcentration: false,
    tags: ['conjuration']
  },
  ...
  },
  {
    ...
    castingTime: '1 hour',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A diamond worth at least 1,000 gp and at least 1 cubic inch of flesh of the creature that is to be cloned, which the spell consumes, and a vessel worth at least 2,000 gp that has a sealable lid and is large enough to hold a Medium creature, such as a huge urn, coffin, mud-filled cyst in the ground, or crystal container filled with salt water.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    castingTime: '10 minutes',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'Burning incense and bits of earth and wood mixed in water.' },
    duration: 'Up to 8 hours',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: 'Up to 1 hour',
    description: 'You attempt to beguile a creature that you can see within range. It must succeed on a wisdom saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are fighting it, it has advantage on the saving throw. While the creature is charmed, you have a telepathic link with it as long as the two of you are on the same plane of existence. You can use this telepathic link to issue commands to the creature while you are conscious (no action required), which it does its best to obey. You can specify a simple and general course of action, such as "Attack that creature," "Run over there," or "Fetch that object." If the creature completes the order and doesn\'t receive further direction from you, it defends and preserves itself to the best of its ability. You ca...',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: true,
    tags: ['enchantment']
  },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '150 feet',
    components: { verbal: true, somatic: true, material: 'A handful of clay, crystal, glass, or mineral spheres.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    castingTime: 'action',
    range: 'Self',
    components: { verbal: true, somatic: true, material: 'A tiny reliquary worth at least 1,000gp containing a sacred relic, such as a scrap of cloth from a saint\'s robe or a piece of parchment from a religious text.' },
    duration: 'Up to 1 minute',
    description: 'Divine light washes out from you and coalesces in a soft radiance in a 30-foot radius around you. Creatures of your choice in that radius when you cast this spell shed dim light in a 5-foot radius and have advantage on all saving throws, and other creatures have disadvantage on attack rolls against them until the spell ends. In addition, when a fiend or an undead hits an affected creature with a melee attack, the aura flashes with brilliant light. The attacker must succeed on a constitution saving throw or be blinded until the spell ends.',
    classes: ['cleric'],
    requiresConcentration: true,
    aoe: { shape: 'sphere', size: 30 },
    tags: ['abjuration']
  },
  {
    id: 'incendiary-cloud',
  ...
  },
  {
    ...
    shortDescription: 'Stun if HP <= 150',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['enchantment']
  },
  ...
  },
  {
    ...
    castingTime: '1 hour',
    range: '10 feet',
    components: { verbal: true, somatic: true, material: 'For each creature you affect with this spell, you must provide one jacinth worth at least 1,000gp and one ornately carved bar of silver worth at least 100gp, all of which the spell consumes.' },
    duration: 'Special',
    description: 'You and up to eight willing creatures within range project your astral bodies into the Astral Plane (the spell fails and the casting is wasted if you are already on that plane). The material body you leave behind is unconscious and in a state of suspended animation; it doesn\'t need food or air and doesn\'t age. Your astral body resembles your mortal form in almost every way, replicating your game statistics and possessions. The principal difference is the addition of a silvery cord that extends from between your shoulder blades and trails behind you, fading to invisibility after 1 foot. This cord is your tether to your material body. As long as the tether remains intact, you can find your way home. If the cord is cut-something that can happen only when an effect specifically states that ...',
    classes: ['cleric', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['necromancy']
  },
  ...
  },
  {
    ...
    castingTime: 'action',
    range: '60 feet',
    components: { verbal: true, somatic: true, material: 'A diamond worth at least 5,000gp.' },
    duration: 'Up to 1 minute',
    description: 'You conjure a portal linking an unoccupied space you can see within range to a precise location on a different plane of existence. The portal is a circular opening, which you can make 5 to 20 feet in diameter. You can orient the portal in any direction you choose. The portal lasts for the duration. The portal has a front and a back on each plane where it appears. Travel through the portal is possible only by moving through its front. Anything that does so is instantly transported to the other plane, appearing in the unoccupied space nearest to the portal. Deities and other planar rulers can prevent portals created by this spell from opening in their presence or anywhere within their domains. When you cast this spell, you can speak the name of a specific creature (a pseudonym, title, or ...',
  ...
  },
  {
    ...
    castingTime: 'minute',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A vellum depiction or a carved statuette in the likeness of the target, and a special component that varies according to the version of the spell you choose, worth at least 500gp per Hit Die of the target.' },
    duration: 'Until dispelled',
  ...
  },
  {
    ...
    shortDescription: '20d6 fire + 20d6 bludg',
    secondaryDamage: [{ dice: '20d6', type: 'bludgeoning' }],
    classes: ['sorcerer', 'wizard'],
  ...
  },
  {
    ...
    shortDescription: 'Instant kill if HP <= 100',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    requiresConcentration: false,
    tags: ['enchantment']
  },
  {
    ...
    components: { verbal: true, somatic: true },
    duration: '10 minutes',
    description: 'A shimmering, multicolored plane of light forms a vertical opaque wall-up to 90 feet long, 30 feet high, and 1 inch thick-centered on a point you can see within range. Alternatively, you can shape the wall into a sphere up to 30 feet in diameter centered on a point you choose within range. The wall remains in place for the duration. If you position the wall so that it passes through a space occupied by a creature, the spell fails, and your action and the spell slot are wasted. The wall sheds bright light out to a range of 100 feet and dim light for an additional 100 feet. You and creatures you designate at the time you cast the spell can pass through and remain near the wall without harm. If another creature that can see the wall moves to within 20 feet of it or starts its turn there, t...',
    classes: ['wizard'],
    requiresConcentration: false,
    tags: ['abjuration']
  },
  ...
  },
  {
    ...
    shortDescription: 'Extra turns, 1d4+1 rounds',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: false,
    tags: ['transmutation']
  },
  {
    ...
    castingTime: 'action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'A drop of mercury, a dollop of gum arabic, and a wisp of smoke.' },
    duration: 'Up to 1 hour',
    description: 'Choose one creature or nonmagical object that you can see within range. You transform the creature into a different creature, the creature into an object, or the object into a creature (the object must be neither worn nor carried by another creature).  The transformation lasts for the duration, or until the target drops to 0 hit points or dies. If you concentrate on this spell for the full duration, the transformation lasts until it is dispelled. This spell has no effect on a shapechanger or a creature with 0 hit points. An unwilling creature can make a Wisdom saving throw, and if it succeeds, it isn\'t affected by this spell. **Creature into Creature.** If you turn a creature into another kind of creature, the new form can be any kind you choose whose challenge rating is equal to or les...',
    classes: ['bard', 'warlock', 'wizard'],
    requiresConcentration: true,
    tags: ['transmutation']
  },
  {
    ...
    castingTime: '1 hour',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'A sprinkle of holy water and diamonds worth at least 25,000gp, which the spell consumes.' },
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    components: { verbal: true, somatic: false },
    duration: 'Instantaneous',
    description: 'Wish is the mightiest spell a mortal creature can cast. By simply speaking aloud, you can alter the very foundations of reality in accord with your desires. The basic use of this spell is to duplicate any other spell of 8th level or lower. You don\'t need to meet any requirements in that spell, including costly components. The spell simply takes effect. Alternatively, you can create one of the following effects of your choice:  - You create one object of up to 25,000 gp in value that isn\'t a magic item. The object can be no more than 300 feet in any dimension, and it appears in an unoccupied space you can see on the ground.  - You allow up to twenty creatures that you can see to regain all hit points, and you end all effects on them described in the greater restoration spell.  - You gran...',
    shortDescription: 'Duplicate any spell, wish for anything',
    classes: ['sorcerer', 'wizard'],
    requiresConcentration: false,
    tags: ['conjuration']
  }
