...
export interface FeatDefinition {
  ...
  /** Unified effect payload (mirrors ClassFeature.effect / RacialTrait.effect).
   *  Populated for all feats as of Phase A schema unification. */
...
export const FEATS_CATALOG: FeatDefinition[] = [
  ...
  },
  {
    ...
    effectType: 'flag',
    effect: { kind: 'ignore-ranged-penalty' }
  },
  {
    id: 'dual-wielder',
    name: 'Dual Wielder',
    ...
    effectType: 'modifier',
    effect: { kind: 'dual-wielder-ac', payload: { bonus: 1 } }
  },
  {
    id: 'shield-master',
  ...
  },
  {
    ...
    effectType: 'modifier',
    effect: { kind: 'reaction-ac-bonus', payload: { bonusType: 'proficiency' } },
  ...
  },
  {
    ...
    effectType: 'modifier',
    effect: { kind: 'speed-bonus', payload: { bonus: 10 } }
  },
  {
    id: 'charger',
    name: 'Charger',
    ...
    effectType: 'flavor',
    effect: { kind: 'charge-damage', payload: { bonus: 5 } }
  },
  {
    id: 'grappler',
    name: 'Grappler',
  ...
  },
  {
    ...
    effectType: 'modifier',
    effect: { kind: 'initiative-bonus', payload: { bonus: 5 } }
  },
  {
    id: 'tough',
    name: 'Tough',
  ...
  },
  {
    ...
    effectType: 'modifier',
    effect: { kind: 'damage-reduction', payload: { amount: 3, types: ['bludgeoning', 'piercing', 'slashing'] } },
  ...
  },
  {
    ...
    effectType: 'modifier',
    effect: { kind: 'death-save-bonus', payload: { bonus: 1 } }
  },
  {
    id: 'skilled',
    name: 'Skilled',
    ...
    effectType: 'modifier',
    effect: { kind: 'extra-skill-profs', payload: { count: 3 } }
  },
  {
    id: 'observant',
    name: 'Observant',
    ...
    effectType: 'modifier',
    effect: { kind: 'passive-skill-bonus', payload: { skills: ['perception', 'investigation'], bonus: 5 } }
  },
  {
    id: 'magic-initiate',
    name: 'Magic Initiate',
  ...
  },
  {
    ...
    effectType: 'flavor',
    effect: { kind: 'temp-hp-from-level-and-cha' }
  },
  {
    id: 'linguist',
    name: 'Linguist',
