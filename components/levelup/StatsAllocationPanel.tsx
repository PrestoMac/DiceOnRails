...
/** Props for the StatsAllocationPanel component. */
...
/** Panel for allocating ability score points during level-up. Shows each stat with +/- controls and remaining points. */
