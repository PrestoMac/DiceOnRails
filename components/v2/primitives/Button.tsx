...
export type ButtonVariant = 'primary' | 'arcane' | 'verdant' | 'ghost' | 'danger' | 'subtle';
...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  verdant:
    'bg-verdant-700 hover:bg-verdant-600 text-verdant-300 border border-verdant-500/40 shadow-[0_4px_20px_rgba(63,166,106,0.25)] disabled:bg-obsidian-750 disabled:text-parchment-faint disabled:border-obsidian-700 disabled:shadow-none',
  ghost:
