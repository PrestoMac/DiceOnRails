...
interface InventoryPanelProps {
  ...
  onTriggerDiceRoll?: (d: Record<string, unknown>) => Promise<void>;
...
const CurrencyRow: React.FC<{
  label: string; iconColor: string; value: number;
  isEditing: boolean; input: string; onStartEdit: ()=>void; onChange: (v:string)=>void; onSave: ()=>void; inputClass: string;
}> = ({ label, iconColor, value, isEditing, input, onStartEdit, onChange, onSave, inputClass }) => (
