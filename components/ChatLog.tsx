        ...
        {filteredMessages.map(msg => {
          ...
          (() => {
            ...
            <div className={`group relative max-w-[85%] rounded-lg p-4 transition-all duration-300 ${bubbleClass}`}>
              ...
              <div className="markdown-content text-stone-300 leading-relaxed"><ReactMarkdown>{formatMessageText(msg.rollData ? msg.text : (cleanedText || msg.text), msg.role)}</ReactMarkdown></div>
          {msg.rollData ? (
