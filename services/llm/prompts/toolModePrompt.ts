...
- Ki (Monk L2): Spend 1 Ki by calling use_resource(resourceId="ki", characterId=monkId, targetId=ACTION) where ACTION is one of: "flurry-of-blows" (two unarmed strikes), "patient-defense" (Dodge bonus action), "step-of-the-wind" (Dash/Disengage bonus action), or a specific enemy name for Stunning Strike (the engine auto-rolls the target's CON save and applies stunned on a failure). A LEVEL-1 MONK HAS ZERO KI — do not allow any ki features.
